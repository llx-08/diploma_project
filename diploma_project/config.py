...
perf_arg.add_argument('--enable_performance', type=str2bool, default=True, help='compare performance against solver')

misc_arg = add_argument_group('User options')

misc_arg.add_argument('--learn_mode', type=str2bool, default=True,
                      help='switch to inference mode when model is learned')
misc_arg.add_argument('--save_model', type=str2bool, default=True, help='save model')
